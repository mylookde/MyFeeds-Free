...
function myfeeds_load_includes() {
    ...
    $image_helpers_file = $includes_dir . 'myfeeds-image-helpers.php';
    if (file_exists($image_helpers_file)) {
        require_once $image_helpers_file;
    }
    ...
    public function init_components() {
        ...
        try {
            ...
            if (class_exists('MyFeeds_Feature_Previews')) {
                ...
                $previews->init();
                myfeeds_log("Feature preview pages initialized");
            }
