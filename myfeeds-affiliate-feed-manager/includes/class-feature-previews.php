...
class MyFeeds_Feature_Previews {
    ...
    public function render_myfeeds_shop() {
        $this->render_preview(array(
            ...
            'screenshots' => array(
                ...
                array(
                    'placeholder' => __('Category taxonomy + filters', 'myfeeds-affiliate-feed-manager'),
                    'caption'     => __('Categories with smart product matching and sidebar filters for brand, color and merchant.', 'myfeeds-affiliate-feed-manager'),
                ),
            ),
            'benefits' => array(
    ...
    public function render_myfeeds_card_design() {
        $this->render_preview(array(
            ...
            'subtitle'   => __('Match the product cards to your brand without writing CSS. Pick fonts, colours, spacing and corner radii from a visual editor, and preview the result on real product data live.', 'myfeeds-affiliate-feed-manager'),
            ...
            'screenshots' => array(
                array(
                    'placeholder' => __('Card design editor', 'myfeeds-affiliate-feed-manager'),
                    'caption'     => __('Sliders for spacing, radius and typography with a live preview.', 'myfeeds-affiliate-feed-manager'),
                ),
                array(
                    'placeholder' => __('Google Fonts picker', 'myfeeds-affiliate-feed-manager'),
                    'caption'     => __('Pick any Google Font for brand, title and price rows.', 'myfeeds-affiliate-feed-manager'),
                ),
            ),
            'benefits' => array(
    ...
    public function render_myfeeds_analytics() {
        $this->render_preview(array(
            ...
            'screenshots' => array(
                array(
                    'placeholder' => __('Analytics dashboard', 'myfeeds-affiliate-feed-manager'),
                    'caption'     => __('Daily clicks, top products, top brands, all in one view.', 'myfeeds-affiliate-feed-manager'),
                ),
                array(
                    'placeholder' => __('Earnings + EPC overview', 'myfeeds-affiliate-feed-manager'),
                    'caption'     => __('Approved revenue and earnings per click, broken down by network.', 'myfeeds-affiliate-feed-manager'),
                ),
            ),
            'benefits' => array(
