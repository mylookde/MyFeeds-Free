...
class MyFeeds_Feature_Previews {
    ...
    public function render_myfeeds_shop() {
        $this->render_preview(array(
            ...
            'benefits' => array(
                __('Your blog gets a real storefront on its own domain. Visitors browse, click out, and you keep the commission.', 'myfeeds-affiliate-feed-manager'),
                __('Category pages search engines actually pick up. You edit titles, slugs and meta tags in bulk from one screen.', 'myfeeds-affiliate-feed-manager'),
                __('Smart sidebar filtering shaped to your catalog. Visitors find what they want without bouncing.', 'myfeeds-affiliate-feed-manager'),
                __('Schema, OpenGraph, sitemap and robots.txt handled in the background. You write, the shop stays indexable.', 'myfeeds-affiliate-feed-manager'),
                __('Best-converting products surface first, so the visitor sees what already pays.', 'myfeeds-affiliate-feed-manager'),
                __('Built on the same feeds you already import. Nothing new to set up.', 'myfeeds-affiliate-feed-manager'),
            ),
        ));
    }
        ...
        $this->render_preview(array(
            ...
            'screenshots' => array(
                array(
                    ...
                    'caption'     => __('Move a slider on the left, the card on the right updates the moment you let go.', 'myfeeds-affiliate-feed-manager'),
                ),
            ),
            'benefits' => array(
                __('Your cards stop looking like a plugin and start looking like your site.', 'myfeeds-affiliate-feed-manager'),
                __('Live preview on real product data. Every change shows up the moment you make it.', 'myfeeds-affiliate-feed-manager'),
                __('Pick colours for card, title, price, discount badge and button.', 'myfeeds-affiliate-feed-manager'),
                __('Full Google Fonts catalog plus your system fonts, no upload needed.', 'myfeeds-affiliate-feed-manager'),
                __('Spacing, padding, corner radius and shadow on sliders. Mobile and desktop side by side.', 'myfeeds-affiliate-feed-manager'),
                __('Save once. Every product card on your site picks up the new look.', 'myfeeds-affiliate-feed-manager'),
            ),
        ));
    }
    ...
    public function render_myfeeds_analytics() {
        $this->render_preview(array(
            ...
            'subtitle'   => __('Stop guessing. Clicks tracked on your own server, conversions pulled from your networks every night, all in one dashboard. You see which post pays, which product converts, which brand carries you.', 'myfeeds-affiliate-feed-manager'),
            'cta_label'  => __('Start 7-day free trial', 'myfeeds-affiliate-feed-manager'),
            ...
            'benefits' => array(
                __('You see earnings and EPC per post, product, brand and network in one place.', 'myfeeds-affiliate-feed-manager'),
                __('Conversions pull in from your affiliate networks every night while you sleep.', 'myfeeds-affiliate-feed-manager'),
                __('Top performers and dead products land in your insight cards as action items.', 'myfeeds-affiliate-feed-manager'),
                __('Click tracking runs on your own server with self-click exclusion, so the numbers are clean.', 'myfeeds-affiliate-feed-manager'),
                __('Day-over-day deltas show you what is rising and what is fading.', 'myfeeds-affiliate-feed-manager'),
                __('Optional Google Analytics 4 event push for your own reporting stack.', 'myfeeds-affiliate-feed-manager'),
            ),
        ));
    }
